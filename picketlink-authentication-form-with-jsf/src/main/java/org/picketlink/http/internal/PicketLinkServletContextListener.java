...
/**
 * <p>
 * A {@link javax.servlet.ServletContextListener} responsible for configure the PicketLink Security Filter to an
 * application.
 * </p>
 *
 * @author Pedro Igor
...
public class PicketLinkServletContextListener implements ServletContextListener
{
    ...
    private void addSecurityFilter(ServletContextEvent sce)
    {
        ...
        FilterRegistration.Dynamic filter = servletContext.addFilter(PICKETLINK_SECURITY_FILTER_NAME,
                    this.securityFilter);
